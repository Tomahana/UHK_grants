  ...
  var MESSAGES = {
    cs: {
      ...
      applyPrestige: {
        ...
        termsFootnoteHtml:
          "Závazné znění: Vyhlášení výzvy č. 1/2026 UHK Prestige (ERC a Horizon Europe). Celková alokace výzvy 3 000 000 Kč.",
        budgetCardTitle: "Rozpočet",
        budgetOfMax: "z max. 500 000 Kč (rok 1)",
        checklistTitle: "Kontrolní seznam",
        helpTitle: "Potřebujete pomoc?",
        submitSuccessTitle: "Přihláška odeslána!",
        submitSuccessP:
    ...
    en: {
      ...
      applyPrestige: {
        ...
        termsFootnoteHtml:
          "Binding text: UHK Prestige call announcement 1/2026 (ERC and Horizon Europe). Total call allocation CZK 3,000,000.",
        budgetCardTitle: "Budget",
        budgetOfMax: "of max. CZK 500,000 (year 1)",
        checklistTitle: "Checklist",
        helpTitle: "Need help?",
        submitSuccessTitle: "Application submitted!",
        submitSuccessP:
        ...
        stepStrategy: "Submission strategy",
        stepBudget: "Budget",
        stepAttachments: "Attachments",

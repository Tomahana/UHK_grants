...
function importPrestigeFormFields() {
  ...
  const rows = [
    ...
    ["support_year1_request","Požadovaná podpora – 1. etapa (Kč)","number","TRUE","5","např. 350000","","Max. 500 000 Kč na 1. etapu dle výzvy č. 1/2026"],
    ["support_year2_request","Plánovaná podpora – 2. etapa (Kč)","number","FALSE","6","např. 600000","","Max. 1 000 000 Kč; pokračování do 2. etapy není nárokové"],
    ["faculty","Součást UHK / pracoviště","select","TRUE","7","","PřF;PdF;FF;FIM;REKTORÁT",""],
    ["department","Katedra / ústav","text","TRUE","8","","",""],
    ["section_iris","IRIS UHK – formální údaje přihlášky","section_header","","9","","",""],
    ["iris_case_id","Referenční ID IRIS UHK (UUID)","text","TRUE","10","","",""],
    ["iris_checklist_result","Souhrn z IRIS (výsledek, Case / Intake ID, skóre)","textarea","TRUE","11","","",""],
    ["section_concept","Concept note a excelence","section_header","","12","","",""],
    ["concept_note","Shrnutí záměru a concept note (max. 2 strany – text)","textarea","TRUE","13","Cíl, vhodnost cílové soutěže, co bude dopracováno, plán externího review / agentury…","","Odpovídá oddílům 1 a 2 šablony žádosti (příloha č. 1 výzvy)"],
    ["excellence_top5","TOP výsledky relevantní pro cílovou soutěž (max. 5)","textarea","TRUE","14","Název, časopis/výstup, rok, DOI/odkaz, vazba na cílový projekt…","","Mezinárodní zkušenost / leadership můžete doplnit do textu"],
    ["prev_erc_he","Předchozí podání do ERC nebo Horizon Europe (pokud existuje)","textarea","FALSE","15","Cílová soutěž, výsledek hodnocení, hlavní kritika posudků, jak nová verze odpoví…","","Pokud jste již podávali – povinné dle šablony; jinak „neaplikuje se“"],
    ["section_strategy","Strategie podání","section_header","","16","","",""],
    ["strategy_why_call","Proč je zvolená cílová soutěž vhodná","textarea","TRUE","17","","",""],
    ["strategy_work_packages","Jaké části návrhu budou připravovány v projektu Prestige","textarea","TRUE","18","","",""],
    ["strategy_external_review","Plán externího review / agentury (pokud plánujete)","textarea","FALSE","19","","",""],
    ["section_budget","Rozpočet 1. etapy","section_header","","20","","",""],
    ["budget_personnel","A. Osobní náklady (max. 40 % etapy)","number","FALSE","21","","","DPP/DPČ, odvody, FKSP – dle přílohy č. 2 výzvy"],
    ["budget_agency","B. Agenturní / mentoringová podpora","number","FALSE","22","","",""],
    ["budget_training","C. Vzdělávání a školení","number","FALSE","23","","",""],
    ["budget_travel","D. Cestovné","number","FALSE","24","","",""],
    ["budget_material","E. Materiál / data / analytické služby","number","FALSE","25","","",""],
    ["budget_other","F. Ostatní způsobilé náklady","number","FALSE","26","","","Např. publikační poplatky, jazyková korektura"],
    ["budget_justification","Odůvodnění rozpočtu","textarea","TRUE","27","","","Vazba položek na aktivitu; součet A–F max. 500 000 Kč (1. etapa)"],
    ["section_attachments","Povinné přílohy","section_header","","28","","",""],
    ["attach_annex1","Příloha č. 1 – šablona žádosti vč. concept note","file","TRUE","29","","pdf,doc,docx","Vyplněná šablona dle výzvy"],
    ["attach_annex2","Příloha č. 2 – šablona rozpočtu + věcné odůvodnění (1. etapa)","file","TRUE","30","","pdf,xlsx,xls",""],
    ["attach_checklist6","Příloha č. 5 – checklist způsobilosti (ERC / HE)","file","TRUE","31","","pdf,doc,docx","Vyplněný checklist – povinná příloha žádosti"],
    ["declaration","Prohlášení","checkbox","TRUE","32","","","Beru na vědomí povinnost podání návrhu a doložení, Zprávu o pokračování k 30. 11. 2026 (příloha č. 3 výzvy), podmínky výzvy č. 1/2026 včetně možnosti pozastavení projektu."],
  ];

  sheet.getRange(1, 1, rows.length, 8).setValues(rows);
  sheet.getRange(4, 1, 1, 8).setBackground("#1C2E5A").setFontColor("white").setFontWeight("bold");
  const sectionOneBasedRows = [5, 13, 16, 20, 24, 32];

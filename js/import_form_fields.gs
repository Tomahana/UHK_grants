...
function importConnectFormFields() {
  ...
  const rows = [
    ...
    ["faculty","Součást UHK","select","TRUE","3","","PřF;PdF;FF;FIM;REKTORÁT",""],
...
function importRegaFormFields() {
  ...
  const rows = [
    ...
    ["faculty","Součást UHK","select","TRUE","7","","PřF;PdF;FF;FIM;REKTORÁT",""],
...
function importPrestigeFormFields() {
  ...
  const rows = [
    ...
    ["faculty","Součást UHK / pracoviště","select","TRUE","6","","PřF;PdF;FF;FIM;REKTORÁT",""],
